...
Partial Class Form2
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "Yang termasuk hewan karnivora ..."
        '
        'Button1
        '
